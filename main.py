...
# 역할 이름 ➡ 역할 ID 매핑
ROLE_IDS = {
    "여자": 1381185791778357329,  # 실제 ID로 변경!
    "남자": 1381185925014491217,
    "10대": 1381205126013784166,
    "20대": 1381204666506809425,
}

DEFAULT_ROLE_IDS = [
    1381184529414488094,  # 주인님 역할 ID
    1381184604639199282,  # 첫손님 역할 ID
]
